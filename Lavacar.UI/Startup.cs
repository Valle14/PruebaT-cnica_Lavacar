...
using Lavacar.AccesoDatos.Repositorios;
...
namespace Lavacar.Presentacion
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<LAVACARContext>(options =>
          options.UseSqlServer(
              Configuration.GetConnectionString("DefaultConnection")));

            services.AddTransient<LogicaServicio>();
            services.AddTransient<LogicaVehiculo>();
